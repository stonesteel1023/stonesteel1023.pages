...
```java
/**
* OBJECTIVE - to understand the interface of java.util.Map and its
implementations
* Optional: sort out the API for sorting
* Optional: understand the use of regular expressions in Java
* ASSIGNMENT
* Calculate the number of occurrences of words in the text without regard to
...
* It is necessary to calculate the number of occurrences of words in the text
without regard for the case of characters
...
* as well as exclusion from consideration of the words enclosed
inside &lt; &gt ;.
*
*/
