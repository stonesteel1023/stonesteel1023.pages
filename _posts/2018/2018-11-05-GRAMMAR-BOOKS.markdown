...
기존에 많은 분들이 보았던 ### 8. 윤성우의 열혈 C++ 프로그래밍 - 개정판, 윤성우 (지은이), 오렌지미디어, 2010>>는 C언어를 선행학습해야 한다는 부담감이 있어서 제외했으며, 만약 내일 당장 프로젝트에 투입된다면 ### 8.
### 이것이 C++이다 - 강의 현장을 그대로 옮긴 C++ 입문서, 최호성 (지은이), 한빛미디어, 2016>>가 훨씬 유익할 수 있습니다.
