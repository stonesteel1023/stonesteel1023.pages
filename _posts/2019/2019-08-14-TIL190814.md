...
title: "java의 Math라이브러리의 pow가 궁금해서 디파일 해봤을 뿐인데.."
tag: java
comment:true
---

출처 : https://java2blog.com/power-function-java/
...
// print 2 to the power 
int i=(int)Math.pow(2,4);
System.out.println("Math.pow(2 ,4)=" + i);
